...
We're getting 21 accidents for women of all races, which is more than their 20. For Black women, there 6 accidents, 1 woman shot while fleeing, and 3 undetermined. That's still not what they have - 20. Assuming this is not the above problem with updated data, let's see if the problem is them looking at different columns than us.
...
There were 8 shootings of unarmed Black women and 2 shootings where it's unknown whether/with what the women were armed. Before we move on, let's quickly fix that unknown and undetermined as separate results. Thank god for Chat GPT, it figured out this code for me.
...
Here, 37 women were unarmed, 13 undetermined/unknown. So we're still getting that magical 10 number. Let's see if it's the problem with our data being newer.
